...
class _UserConfigScreenState extends State<UserConfigScreen> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildLanguageCard(colorScheme, l10n, localeService),
        ],
      ),
    );
  }
      ...
      children: [
        CircleAvatar(
          ...
          child: Text(
            ...
            // fontSize fijo: es un elemento decorativo, no contenido
        ...
        Expanded(
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Expanded(
                    child: Text(
                      _displayName,
                      // Sin fontSize: hereda titleMedium del tema (16 estándar / 24 baja visión)
                  ...
                  // Botón de cerrar sesión: fontSize fijo para no desbordar el Row
                  TextButton.icon(
                    onPressed: _signOut,
              ...
              // Sin fontSize: hereda bodySmall del tema (12 estándar / 18 baja visión)
              Text(
                l10n.configSubtitle,
  ...
  Widget _buildHealthProfileCard(ColorScheme colorScheme, AppLocalizations l10n) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        // Sin fontSize: ListTile usa titleMedium del tema automáticamente
        title: Text(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.accessibility_new_outlined, color: colorScheme.primary),
                ),
                const SizedBox(width: 16),
                Text(
          ...
          SwitchListTile(
            ...
            // Sin style en el Text: SwitchListTile aplica bodyLarge del tema
            title: Text(l10n.configLowVisionTitle),
            subtitle: Text(
  ...
  /// Cambia el locale de la app de forma inmediata vía [LocaleService] + Provider.
  Widget _buildLanguageCard(ColorScheme colorScheme, AppLocalizations l10n, LocaleService localeService) {
    final textTheme = Theme.of(context).textTheme;
    final languages = [
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.language_outlined, color: colorScheme.primary),
                ),
                const SizedBox(width: 16),
                Text(
          ...
          const Divider(height: 1, indent: 20, endIndent: 20),
          // Sin style en el Text: RadioListTile aplica bodyLarge del tema
          ...languages.map(
            (lang) => RadioListTile<String>(
              contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 0),
              title: Text(lang.$2),
              value: lang.$1,
              groupValue: localeService.languageCode,
              onChanged: (val) {
                if (val != null) localeService.setLocale(val);
              },
